...
@Composable
fun DashboardScreen(
    onNavigateToCourses: () -> Unit, // Callback para navegar
    onNavigateToSupports: () -> Unit,
    onNavigateToChatbot: () -> Unit,
    onNavigateToGeomap: () -> Unit
) {
    // SemillaDigitalTheme { // El tema ya se aplica en MainActivity
    Scaffold(
        topBar = {
        ...
        Column(
            ...
            Row(
                ...
                ServiceButton(
                    ...
                    onClick = onNavigateToCourses, // ¡Aquí lo conectamos!
                    modifier = Modifier.weight(1f)
                )
                ServiceButton(
...
fun ServiceButton(
    ...
    Card(
        modifier = modifier.aspectRatio(1f), // Para que sea cuadrado
